...
public class CloudServiceConfig extends WebSecurityConfigurerAdapter {
    ...
    public CloudServiceConfig(UserService userService, JwtAuthenticationEntryPoint jwtAuthenticationEntryPoint, JwtRequestFilter jwtRequestFilter) {
